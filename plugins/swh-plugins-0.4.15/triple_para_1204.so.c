...
#define D_(s) (s)
	...
	if (tripleParaDescriptor) {
		...
		port_range_hints[TRIPLEPARA_FC_L].LowerBound = 0;
		port_range_hints[TRIPLEPARA_FC_L].UpperBound = 0.5;
		...
		port_range_hints[TRIPLEPARA_FC_1].HintDescriptor =
		 LADSPA_HINT_BOUNDED_BELOW | LADSPA_HINT_BOUNDED_ABOVE | LADSPA_HINT_SAMPLE_RATE | LADSPA_HINT_DEFAULT_LOW;
		port_range_hints[TRIPLEPARA_FC_1].LowerBound = 0;
		port_range_hints[TRIPLEPARA_FC_1].UpperBound = 0.5;
		...
		port_range_hints[TRIPLEPARA_FC_2].HintDescriptor =
		 LADSPA_HINT_BOUNDED_BELOW | LADSPA_HINT_BOUNDED_ABOVE | LADSPA_HINT_SAMPLE_RATE | LADSPA_HINT_DEFAULT_MIDDLE;
		port_range_hints[TRIPLEPARA_FC_2].LowerBound = 0;
		port_range_hints[TRIPLEPARA_FC_2].UpperBound = 0.5;
		...
		port_range_hints[TRIPLEPARA_FC_3].HintDescriptor =
		 LADSPA_HINT_BOUNDED_BELOW | LADSPA_HINT_BOUNDED_ABOVE | LADSPA_HINT_SAMPLE_RATE | LADSPA_HINT_DEFAULT_HIGH;
		port_range_hints[TRIPLEPARA_FC_3].LowerBound = 0;
		port_range_hints[TRIPLEPARA_FC_3].UpperBound = 0.5;
		...
		port_range_hints[TRIPLEPARA_FC_H].LowerBound = 0;
		port_range_hints[TRIPLEPARA_FC_H].UpperBound = 0.5;
